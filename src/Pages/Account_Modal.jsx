...
const Account_Modal = () => {
  ...
  return (
    <>
      <Button type="" className='border-0 text-xl' onClick={showModal}>
      {user && user.name}
      </Button>
...
//   return (
//     <>
//       <Button type="" className='border-0 text-xl' onClick={showLoading}>
//         {/* {user && user.name} */}
//       </Button>
//       <Modal
