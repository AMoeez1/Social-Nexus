...
function Login() {
	...
	const handleSubmit = async (val) => {
		setLoading(true);
		try {
			const { data } = await axiosReq.post('/login', val)
			...
			<div className="flex justify-center h-screen bg-gray-800">
				<div className="container">
					<div className="flex justify-center">
						<div className="w-full bg-gray-100 max-w-md border-2 mt-16 rounded-xl shadow-xl">
							<div className="card container p-4">
								...
								<Form form={loginForm} onFinish={handleSubmit}>
									...
									<Button htmlType="submit" type='primary' className='w-full h-10' loading={loading}>Login</Button>
								</Form>
								<h5 className="text-center my-4 "></h5>
								<hr />
								<div className="text-center mt-4">
									<a href="#" className="nav-link text-dark">Forgot password?</a>
								</div>
							</div>
							<div className="card container text-center pb-8">
								<h6>
