    ...
    return (
        <div className="container block md:hidden" >
            <div className="flex items-center">
                ...
                <div className="py-1 px-3 rounded-lg flex justify-end">
                    <label htmlFor="search"><i className="fa fa-search" aria-hidden="true"></i></label>
                    <input type="text" id="search" placeholder="Search" className="bg-light h-8 my-2 ml-40 p-6 border-none outline-none" />
                </div>
                <a href="#" className="text-dark text-lg mx-3">
                    <FaHeart size={30}/>
                </a>
            </div>
            <hr className="my-4" />
