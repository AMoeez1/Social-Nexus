...
function Header() {
	return (
		<div className="container bg-gray-100 block sm:hidden w-screen py-2" >
			<div className="flex items-center">
				<Link to="/" className="text-dark mx-3 mt-4">
					<svg xmlns="http://www.w3.org/2000/svg" width="100" height="40" viewBox=".182 .548 511.304 171.879"
						id="instagram">
						<path
						fill='black'
                    ...
                    <Link to='/chatbot/ai' className="nav-link flex justify-end mx-auto gap-2">
                        <RiRobot2Fill size={25} />
						<p className='font-bold'>Meta AI</p>
