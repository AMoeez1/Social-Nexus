...
export default function Sidebar() {
	...
	return (
		<div className="flex bg-white">
			<div
				className="min-w-[250px] max-w-[30rem]  hidden lg:block p-3"
				style={{ width: `${width / 16}rem` }}
			>
				<div className=" py-3 px-5 rounded-md ">
					<ul className="flex flex-col">
						<li className="nav-item">
							<Link to='/' className="nav-link flex justify-center py-5">
						...
						</li>
						{
							sidebar.map((item) => (
								<li key={item.id} className="nav-item">
									<Link to={item.href} className="nav-link flex items-center py-4 text-sm font-semibold px-4 text-gray-800 hover:bg-gray-200">
						...
						<div className="px-5 py-16 cursor-pointer">
							<Dropdown
								menu={{
									items,
								}}
			...
			{/* Handle */}
			<div
				className="w-2 cursor-col-resize border-r-2"
				onMouseDown={() => {
