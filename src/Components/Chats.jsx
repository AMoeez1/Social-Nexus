  ...
  <div className="flex flex-col h-screen w-full bg-background text-foreground">
    ...
    <div className="flex-1 overflow-y-auto p-4 space-y-4">
      <div className="flex items-start space-x-2">
        <img src="https://placehold.co/40x40" alt="User avatar" className="rounded-full" />
        <div>
          <div className="bg-card p-2 rounded-lg shadow-sm text-primary-foreground">
            <p>Message send by someone else</p>
          </div>
        </div>
      </div>
    ...
    <div className="p-4 border-t border-border gap-8 flex items-center">
